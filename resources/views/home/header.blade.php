                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item" >
                        <a href="{{ url('show_cart') }}" style="margin-right: 0px;">
                            <div class="nav-link" onmouseover="this.querySelector('.fas').style.color='#2E68A2';" onmouseout="this.querySelector('.fas').style.color='rgba(21, 48, 74, 0.9)';">
                            <span>Keranjang </span><i class="fas fa-shopping-cart" style="color: rgba(21, 48, 74, 0.9);"></i>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a
                            style="background-color: #F3C06B; margin-left: 17px; border: 1px solid white; color: #15304a; font-weight: 500; transition: background-color 0.3s;"
                    ...
                    <li class="nav-item">
                        <a
                            style="background-color: #F3C06B; margin-left: 3px; border: 1px solid white; color: #15304a; font-weight: 500; transition: background-color 0.3s;"
                            onmouseover="this.style.backgroundColor = ''; this.style.color = '#ffff';"
                            onmouseout="this.style.backgroundColor = '#F3C06B'; this.style.color = '#15304a';"
                            onclick="this.style.backgroundColor = '#F3C06B'; this.style.color = '#15304a';"
                            class="btn btn-primary"
