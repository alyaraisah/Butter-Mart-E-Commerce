              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Total Pelanggan</h6>
                  </div>
                </div>
              </div>
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Total Penghasilan</h6>
                  </div>
                </div>
              </div>
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Pesanan Diproses</h6>
                  </div>
                </div>
              </div>
